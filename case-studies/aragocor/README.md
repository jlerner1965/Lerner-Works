...
| File | Placement |
|---|---|
| `01-home-hero.jpg` | Lead image (also the OG image for this page) |
| `01-home-hero-thumb.jpg` | 800 px card thumbnail for `/work/` and the home page, generated by `tools/optimize-images.js` |
